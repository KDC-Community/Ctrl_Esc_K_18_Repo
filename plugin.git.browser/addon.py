...
def addonuri():
	kodi.add_menu_item({'mode': 'search', 'type': 'username', 'query': 'KDC-Community'}, {'title': '[COLOR darkorange]Ctrl_Esc Addons[/COLOR] - by Ctrl_Esc'},  icon='null')
	kodi.add_menu_item({'mode': 'search', 'type': 'username', 'query': 'Control-Escape'}, {'title': '[COLOR darkorange]Control-Escape Addons[/COLOR] - by Control-Escape'},  icon='null')
	kodi.add_menu_item({'mode': 'search', 'type': 'username', 'query': '42ona'}, {'title': '[COLOR darkorange]42ona Addons[/COLOR] - by 42ona'},  icon='null')
	kodi.add_menu_item({'mode': 'search', 'type': 'username', 'query': 'Gujal00'}, {'title': '[COLOR darkorange]Gujal00 Addons[/COLOR] - by Gujal00'},  icon='null')
	kodi.add_menu_item({'mode': 'search', 'type': 'username', 'query': 'streamxstream'}, {'title': '[COLOR darkorange]streamxstream Addons[/COLOR] - by streamxstream'},  icon='null')
	kodi.add_menu_item({'mode': 'search', 'type': 'username', 'query': 'DeBaschdi'}, {'title': '[COLOR darkorange]DeBaschdi Addons[/COLOR] - by DeBaschdi'},  icon='null')
	kodi.add_menu_item({'mode': 'search', 'type': 'username', 'query': 'Sandmann79'}, {'title': '[COLOR darkorange]Sandmann79 Addons[/COLOR] - by Sandmann79'},  icon='null')
	kodi.add_menu_item({'mode': 'search', 'type': 'username', 'query': 'Collabsvito'}, {'title': '[COLOR darkorange]Collabsvito Addons[/COLOR] - by Collabsvito'},  icon='null')
...
@kodi.register('users')
def users():
	kodi.add_menu_item({'mode': 'search', 'type': 'username', 'query': 'KDC-Community'}, {'title': 'Ctrl_Esc Addons'},  icon='null')
	kodi.add_menu_item({'mode': 'search', 'type': 'username', 'query': 'Control-Escape'}, {'title': 'Control-Escape Addons'},  icon='null')
	kodi.add_menu_item({'mode': 'search', 'type': 'username', 'query': '42ona'}, {'title': '42ona Addons'},  icon='null')
	kodi.add_menu_item({'mode': 'search', 'type': 'username', 'query': 'Gujal00'}, {'title': 'Gujal00 Addons'},  icon='null')
	kodi.add_menu_item({'mode': 'search', 'type': 'username', 'query': 'streamxstream'}, {'title': 'streamxstream Addons'},  icon='null')
	kodi.add_menu_item({'mode': 'search', 'type': 'username', 'query': 'DeBaschdi'}, {'title': 'DeBaschdi Addons'},  icon='null')
	kodi.add_menu_item({'mode': 'search', 'type': 'username', 'query': 'Sandmann79'}, {'title': 'Sandmann79 Addons'},  icon='null')
	kodi.add_menu_item({'mode': 'search', 'type': 'username', 'query': 'Collabsvito'}, {'title': 'Collabsvito Addons'},  icon='null')
